      ...
      <div class="container mx-auto px-4 max-w-4xl">
        ...
        <div class="mb-8">
          ...
          <div class="bg-gray-100 p-6 rounded-lg shadow-lg">
            ...
            <div class="mb-6">
              <p class="mb-2">Este modelo simula un sistema de colas con múltiples servidores, llegadas de Poisson y tiempos de servicio con distribución general.</p>
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <input type="number" v-model.number="arrivalRate" @input="arrivalRate = Math.max(0, arrivalRate)"
                       class="w-full bg-tertiary text-primary p-2 rounded" />
              </div>
              <div>
                <label class="block text-sm font-medium mb-1">Tasa de servicio (μ)</label>
                <input type="number" v-model.number="serviceRate" @input="serviceRate = Math.max(0.1, serviceRate)"
                       class="w-full bg-tertiary text-primary p-2 rounded" />
              </div>
            </div>
        ...
        <div class="mb-8">
          ...
          <p class="mb-4">
            Para experimentar de manera interactiva con este modelo de colas, recomendamos el juego "Two Point Hospital". Este juego simula la gestión de un hospital, donde deberás manejar múltiples departamentos y personal médico para atender a los pacientes, similar a un sistema M/G/c.
          </p>
          <div class="bg-tertiary border-2 border-secondary p-4 rounded-lg">
            <img src="/image/imageHome/gameTema3.jpg" alt="Two Point Hospital" class="w-full h-64 object-cover rounded-lg mb-4">
            <p class="mb-4">
              En "Two Point Hospital", experimentarás:
            </p>
            <ul class="list-disc list-inside mb-4">
              <li>Gestión de múltiples departamentos médicos (servidores)</li>
              <li>Llegadas de pacientes (clientes) de manera aleatoria</li>
              <li>Tiempos de tratamiento (servicio) variables</li>
              <li>Decisiones sobre la contratación de personal y la expansión del hospital</li>
            </ul>
            <a href="https://store.steampowered.com/app/535930/Two_Point_Hospital/" target="_blank" class="bg-secondary text-primary font-bold py-2 px-4 rounded hover:bg-opacity-80 transition duration-300">
              Descargar Two Point Hospital
            </a>
          </div>
        </div>
