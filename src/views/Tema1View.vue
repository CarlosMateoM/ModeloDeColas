<template>
    ...
    <div class="bg-tertiary text-primary min-h-screen p-8">
        ...
        <img class="w-full h-96 rounded object-cover" src="/image/imageHome/imgTema1.jpeg"
            alt="Modelo de múltiples canales con llegadas Poisson, tiempos de servicio arbitrarios y sin línea de espera">
        ...
        <div class="mb-8">
            ...
            <p class="mb-4">
                El modelo de múltiples canales con llegadas Poisson, tiempos de servicio arbitrarios y sin línea de
                espera, también conocido como modelo de pérdidas M/G/m/m, es una variación del modelo de colas M/M/m.
                Este modelo implica un sistema en el cual no se permite esperar.
            </p>
            <p>
                Las unidades o clientes que llegan buscan ser atendidos en uno de varios canales de servicio. Si todos
                los canales están ocupados, a las unidades que llegan se les niega el acceso al sistema. En terminología
                de línea de espera, las llegadas que ocurren cuando el sistema está completo son bloqueadas y eliminadas
                del sistema. Tales clientes pueden perderse o intentar regresar más tarde al sistema.
            </p>
        </div>
        ...
        <div class="mb-8">
            ...
            <ul class="list-disc list-inside">
                ...
                <li>Una llegada que ocurre cuando todos los canales están ocupados es bloqueada, es decir, se le niega
                    el servicio y no se le permite entrar al sistema.</li>
            </ul>
        </div>
        ...
        <div class="mb-8">
            ...
            <div class="bg-primary text-tertiary p-4 rounded-lg mb-4">
                ...
                <p class="mb-2">P<sub>k</sub> = (λ/μ)<sup>k</sup> / k! / Σ<sub>j=0</sub><sup>k</sup> [(λ/μ)<sup>j</sup>
                    / j!]</p>
                <p>Donde:</p>
                <ul class="list-disc list-inside">
            ...
            <p class="mb-4">
                El valor de probabilidad más importante es P<sub>k</sub>, el cual es la probabilidad de que todos los k
                canales estén ocupados. En porcentaje, P<sub>k</sub> indica el porcentaje de llegadas bloqueadas y a las
                que se les niega el acceso al sistema.
            </p>
        ...
        <div class="mb-8">
            ...
            <p>
                Una aplicación primordial de este modelo implica el diseño de sistemas de comunicación telefónicos u
                otros sistemas de comunicación donde las llegadas son las llamadas y los canales son el número de líneas
                telefónicas o de comunicación disponibles. En un sistema como ese, las llamadas se hacen a un número
                telefónico, con cada llamada automáticamente dirigida a un canal abierto, si es posible. Cuando todos
                los canales están ocupados, las llamadas adicionales reciben un tono de ocupado y se les niega el acceso
                al sistema.
            </p>
        </div>
