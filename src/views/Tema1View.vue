<template>
  ...
  <div class="bg-tertiary text-primary min-h-screen p-8">
    ...
    <div class="mb-8">
      ...
      <p class="mb-4">
        A continuación, se presenta un ejemplo interactivo basado en el caso de Microdata Software, Inc. Puede ajustar los parámetros para ver cómo afectan al sistema.
      </p>
